...
//clsFileUpload Class @0-A4A8998A
class clsFileUpload
{
  ...
  function Upload($RowNumber = "")
  {
    ...
    if (strlen(CCGetParam($DeleteControl))) { 
      ...
      $this->Errors->addError($CCSLocales->GetText('CCS_WrongType', $this->Caption));
        ...
        $index = 0;
        while($file_exists) {
          $ActualFileName = date("Ymd-His-") . $index . "." . $FileName;
