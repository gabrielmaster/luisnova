<?php
//Include Common Files @1-9F2E5000
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "galeria_luisnova.php");
...
class clsRecordgaleria_fotosSearch { //galeria_fotosSearch Class @3-BCECDF3C
...
//Class_Initialize Event @3-5A369B71
...
//Operation Method @3-AF2ABF83
    function Operation()
    {
        ...
        $Redirect = "galeria_luisnova.php";
    }
//End Operation Method

//Show Method @3-1D02288C
    function Show()
    {
        global $CCSUseAmp;
        global $Tpl;
...
} //End galeria_fotosSearch Class @3-FCB6E20C

class clsGridgaleria_fotos { //galeria_fotos class @2-95D4C1A3
...
//Class_Initialize Event @2-E8685B13
    ...
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->Foto->Attributes->SetValue("height", 400);
...
//DataSource Variables @2-2B1C5435
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-AEE7DBF1
...
//SetOrder Method @2-50C71F37
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "Orden, id desc";
        $this->Order = CCGetOrder($this->Order, $SorterName, $SorterDirection, 
            "");
    }
//End SetOrder Method

//Prepare Method @2-CFDD5FF0
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "galeria_luisnova.html";
$BlockToParse = "main";
...
//Include events file @1-0860D89B
include_once("./galeria_luisnova_events.php");
...
//Execute Components @1-2B716169
$galeria_fotosSearch->Operation();
//End Execute Components

//Go to destination page @1-3325E68C
if($Redirect)
{
